...
final ThemeData myThemeLight = ThemeData(
 ...
 if (states.contains(MaterialState.selected)) { return const Color( 0xff00897b ); }
 return null;
 }),
 ...
 ), bottomAppBarTheme: const BottomAppBarTheme(color: Color( 0xff00897b )), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.teal).copyWith(background: const Color( 0xff80cbc4 )).copyWith(error: const Color( 0xffd32f2f )).copyWith(secondary: const Color( 0xff009688 )), textSelectionTheme: const TextSelectionThemeData(cursorColor: Color( 0xff4285f4 ), selectionColor: Color( 0xff80cbc4 ), selectionHandleColor: Color( 0xff4db6ac ),),
  );
