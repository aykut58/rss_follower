 ...
 return null;
 ...
 ), bottomAppBarTheme: const BottomAppBarTheme(color: Color( 0xff424242 )), colorScheme: ColorScheme.fromSwatch(primarySwatch: const MaterialColor(4280361249,{50: const Color( 0xfff2f2f2 )
		...
		, 900: const Color( 0xff191919 )
		})).copyWith(background: const Color( 0xff616161 )).copyWith(error: const Color( 0xffd32f2f )).copyWith(secondary: const Color( 0xff64ffda )), textSelectionTheme: const TextSelectionThemeData(cursorColor: Color( 0xff4285f4 ), selectionColor: Color( 0xff64ffda ), selectionHandleColor: Color( 0xff1de9b6 ),),
  );
